...
public class MonitorCPU {
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Ingresa la cantidad de consumos de CPU en porcentaje (enteros). Escribe -1 para terminar.");
            ...
            while (true) {
                ...
                if (valor < 0 || valor > 100) {
                    System.out.println("Valor fuera de rango. Debe ingresar un número entre 0 y 100.");
                    continue;
                }
